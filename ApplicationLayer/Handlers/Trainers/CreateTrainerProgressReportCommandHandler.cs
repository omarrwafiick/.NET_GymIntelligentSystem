...
namespace ApplicationLayer.Handler.Trainers
{
    public class CreateTrainerProgressReportCommandHandler : IRequestHandler<CreateTrainerProgressReportCommand, bool>
    {
        ...
        public async Task<bool> Handle(CreateTrainerProgressReportCommand request, CancellationToken cancellationToken)
        {
            ...
            if (member is null || trainer is null || relationExists is null) return false;
